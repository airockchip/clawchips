...
export const DEFAULT_SCORING_CONFIG: ScoringConfig = {
  ...
  codeKeywords: [
    ...
    "decoder.py", "filter.py", "migrate_data.py", "decode.py", "cuda", "int8", "jsonl",
    "python", "c++", "java", "javascript", "typescript", "csharp", "php", "ruby", "go", "rust",
    "swift", "kotlin", "scala", "haskell", "erlang", "elixir", "ocaml", "prolog", "lisp", "scheme", "common lisp",
    "emacs lisp", "clojure", "racket", "factor", "smalltalk", "c language", "c语言",
    "函数", "类", "导入", "定义",
    "查询", "异步", "等待", "常量", "变量", "返回",
