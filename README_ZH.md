...
如果开启记忆路由功能，还需要按照如下在RK3588本地部署一个embedding模型服务
...
启动后即可访问Dashboard Web页面，访问的URL： `http://<ip>:18789/plugins/clawchips/dashboard`
...
```
@model(MiniMax-M2.5) 请写一个可以收发邮件的SKILL
```
